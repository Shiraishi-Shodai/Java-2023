...
public class Student {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof Student))
			return false;
		Student r = (Student) o;
		if (!this.name.equals(r.name) || !this.address.equals(r.address) || this.year != r.year || this.month != r.month
				|| this.day != r.day) {
			return false;
		}
		return true;
	...
	public int hashCode() {
		return Objects.hash(this.name,this.address,this.year,this.month,this.day);
	}
}
